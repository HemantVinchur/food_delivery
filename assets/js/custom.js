...
//toggle drop down
function drop_down(){
  var drop_down=document.getElementById('nav');
  var drop_down_class=drop_down.className;
  if (drop_down_class==='closed') {
    drop_down.className='open';
  }else {
    drop_down.className='';
    setTimeout(function(){
      drop_down.className='closed';
    }, 700);
  }
}
